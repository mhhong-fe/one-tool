...
export const categoryIcons: IconOption[] = [
  ...
  { key: 'EarlySleep', icon: 'mdi:bed-clock', label: '早睡早起' },
  { key: 'English', icon: 'mdi:translate', label: '英语' },
  { key: 'Pen', icon: 'mdi:pen', label: '写作' },
  { key: 'Camera', icon: 'mdi:camera', label: '摄影' },
  { key: 'Dumbbell', icon: 'mdi:dumbbell', label: '哑铃' },
  { key: 'PushUp', icon: 'mdi:human-handsdown', label: '俯卧撑' },
  { key: 'Crunch', icon: 'mdi:yoga', label: '卷腹' },
